...
class Window(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.xSlider = self.createSlider(QtCore.SIGNAL("xRotationChanged"),
                                         self.glWidget.setXRotation)
        self.ySlider = self.createSlider(QtCore.SIGNAL("yRotationChanged"),
                                         self.glWidget.setYRotation)
        self.zSlider = self.createSlider(QtCore.SIGNAL("zRotationChanged"),
